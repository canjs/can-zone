...
function browserZone(data){
	...
	var propsToIgnore = { onreadystatechange: true, onload: true };
	var readystateignored = { onreadystatechange: true, onload: true, responseText: true };
	...
	var assignIgnoredProps = function(xhr, ignore){
		ignore.responseText = xhr.readyState !== 4 ||
			xhr.responseType === "arraybuffer";
		ignore.responseXML = xhr.responseType === "arraybuffer";
	};
	...
	XHR.prototype.send = function(){
		...
		realXhr.onreadystatechange = function(){
			assignIgnoredProps(realXhr, readystateignored);
			assign(fakeXhr, realXhr, readystateignored);
