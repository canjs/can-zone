...
exports.WebSocketDescriptor = function(descriptor){
	return {
		get: descriptor.get,
		set: function(onmessage){
			var fn = function(){
				var oldZone = CanZone.current;
				CanZone.current = CanZone.current || CanZone.inner;
				var res = onmessage.apply(this, arguments);
				CanZone.current = oldZone;
				return res;
			};
