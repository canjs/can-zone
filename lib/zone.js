...
Object.defineProperty(Zone, "inner", {
	get: function(){
		return this._inner;
	}
	set: function(zone){
		this._inner = zone;
		zone.deferred.promise.then(function(){
			Zone.inner = zone.parent;
		});
	}
});
...
Zone.prototype.run = function(fn){
	...
	// Set this as the inner most Zone being run.
	Zone.inner = this;
