...
exports.requestAnimationFrame = function(rAF){
	return function(fn){
		var callback = can.Zone.current.waitFor(fn);
...
exports.then = function(then){
	return function(onFulfilled, onRejected){
		var fn;
		var rejected;
		var callback = can.Zone.current.waitFor(function(val){
			if(fn) {
				return fn.apply(this, arguments);
			} else if(rejected) {
...
exports.send = function(send){
	...
	return function(){
		...
		function createCallback(fn){
			fn = fn || function(){};
			return function(){
				var task = new can.Zone.Task(zone, fn);
